...
CMPAHeader::CMPAHeader(CMPAStream *pStream, std::uint32_t &dwOffset, bool bExactOffset, bool bReverse, CMPAHeader *pCompareHeader) : m_wAllocationTableIndex(0), m_wBound(32)
{
	...
	while (auto *pHeader = pStream->ReadBytes(4, dwOffset, false, bReverse))
	{
...

		{
			...
			*/
			...
			{
				std::fprintf(stderr, "Exception at construction of MPAHeader.");
