...
// static variables
const char* CMPAHeader::m_szLayers[] = { _T("Layer I"), _T("Layer II"), _T("Layer III") };
const char* CMPAHeader::m_szMPEGVersions[] = {_T("MPEG 2.5"), _T(""), _T("MPEG 2"), _T("MPEG 1") };
const char* CMPAHeader::m_szChannelModes[] = { _T("Stereo"), _T("Joint Stereo"), _T("Dual Channel"), _T("Single Channel") };
const char* CMPAHeader::m_szEmphasis[] = { _T("None"), _T("50/15ms"), _T(""), _T("CCIT J.17") };

// sampling rates in hertz: 1. index = MPEG Version ID, 2. index = sampling rate index
const std::uint32_t CMPAHeader::m_dwSamplingRates[4][3] = 
{ 
...
const std::uint32_t CMPAHeader::m_dwBitrates[2][3][15] =
{
	{	// MPEG 1
...
const std::uint32_t CMPAHeader::m_dwSamplesPerFrames[2][3] =
{
	{	// MPEG 1
		384,	// Layer1
		1152,	// Layer2	
...
// Samples per Frame / 8
const std::uint32_t CMPAHeader::m_dwCoefficients[2][3] =
{
	{	// MPEG 1
...
// slot size per layer
const std::uint32_t CMPAHeader::m_dwSlotSizes[3] =
{
	4,			// Layer1
	1,			// Layer2
	1			// Layer3
...
const std::uint32_t CMPAHeader::m_dwSideInfoSizes[2][2] =
{
	// MPEG 1
	{32,17},
	// MPEG 2/2.5
...
const std::uint32_t CMPAHeader::m_dwTolerance = 6;	// +/-3 bytes

// max. range where to look for frame sync
const std::uint32_t CMPAHeader::m_dwMaxRange = 16384;
...
CMPAHeader::CMPAHeader(CMPAStream* pStream, std::uint32_t& dwOffset, bool bExactOffset, bool bReverse, CMPAHeader* pCompareHeader) :
	m_wAllocationTableIndex(0), m_wBound(32)
{
	// look for synchronisation
	std::uint32_t dwStep = 1;
